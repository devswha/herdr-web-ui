...
export const KO: Record<string, string> = {
  ...
  "Pair this device with a code from the PC: Settings → Devices, on the PC itself.": "PC에서 받은 코드로 이 기기를 페어링하세요. PC 자체의 설정 → 기기에 있습니다.",
  "Pairing code": "페어링 코드",
  "Pairing…": "페어링 중…",
  ...
  "A paired device gets in on its own, from anywhere it can reach this server, until you revoke it here. Pairing needs a code from this screen, on the PC or on a device already paired.": "페어링된 기기는 여기서 폐기하기 전까지, 이 서버에 닿는 어디서든 스스로 들어옵니다. 페어링에는 이 화면의 코드가 필요하며, PC나 이미 페어링된 기기에서 받을 수 있습니다.",
  "Loading…": "불러오는 중…",
